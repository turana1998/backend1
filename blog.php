                ...
                <div class="col-lg-8 posts-list">
                    <div class="single-post">
                        <div class="feature-img">
                            <img class="img-fluid" src="<?= $Blog["sekil"]?>"
                                alt="">
                        </div>
                        <div class="blog_details">
                            ...
                            <p class="excert">
                             <a href=" <?= $Portfolio["link"]?>"> <?= $Blog["slug"]?></a>
                            </p>
                            <p>
                    ...
                    <div class="navigation-top">
                        <div class="d-sm-flex justify-content-between text-center">
                            ...
                            <ul class="social-icons">
                                <li><a href="../../sai4ull.html"><i class="fab fa-facebook-f"></i></a></li>
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget popular_post_widget">
                            ...
                            <div class="media post_item">
                                <img width="50px" height="50px" src="<?=$BlogList[$i]["sekil"]?>" alt="post">
                                <div class="media-body">
                                    <a href="blog_details.html">
                                        <h3 style="color: #2d2d2d;"><?=$BlogList[$i]["title"]?></h3>
                                    </a>
                                    <p><?=$BlogList[$i]["date"]?></p>
                                </div>
                            </div>
